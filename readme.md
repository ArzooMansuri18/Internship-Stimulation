...
<ol>
    <li>FAQ Accordion</li>
    <li>Tab Navigation Component</li>
    <li>Custom Dropdown Menu</li>
    <li>Color Picker Tool</li>
    <li>Password Strength Indicator</li>
    <li>Real-Time Form Validation</li>
    <li>Survey Form with Conditional Fields</li>
    <li>Dynamic To-Do List</li>
    <li>Mini Dashboard Page</li>
    <li>Sliding Image Gallery</li>
    <li>Progress Bar Animation</li>
    <li>Mouse Hover Portfolio Card</li>
    <li>Dynamic News Ticker</li>
...
<ul>
    ...
    <li>Can be extended tofetch API data</li>
</ul>
